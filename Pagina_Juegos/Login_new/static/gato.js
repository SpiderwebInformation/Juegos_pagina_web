...
// Agregar el siguiente código para detener el juego y mostrar los resultados cuando se presiona el botón "Terminar Partida"
document.getElementById("terminarPartida").addEventListener("click", function () {
  juegoActivo = false; // Finaliza el juego
  document.querySelector('.endgame').style.display = "block";
  document.querySelector('.endgame .text').innerText = "Partida Terminada";
...
function turnClick(square) {
  if (juegoActivo && typeof origBoard[square.target.id] === 'number') {
...
function emptySquares() {
  return origBoard.filter((elm, i) => typeof elm === 'number');
}
